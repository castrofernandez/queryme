...
var isEnabled = function isEnabled() {
  return Options.get('update_url') && isCompatible();
};
...
var processParametersFromUrlAndStorage = function processParametersFromUrlAndStorage() {
  Parameters.update(_objectSpread({}, Storage.get(), Querystring.get(), Options.get('default_values')));
  updateUrlAndStore();
};
...
var isEnabled = function isEnabled() {
  return Options.get('local_storage') && isCompatible();
};
